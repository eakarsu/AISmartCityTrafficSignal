...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState('admin@trafficsignal.io');
  ...
  return (
    <div className="login-shell">
      <form className="login-card" onSubmit={handleSubmit}>
        <h1 className="login-brand">TRAFFIC SIGNAL</h1>
        <p className="login-sub">Adaptive Smart-City Ops</p>
        ...
        <p className="login-hint">
          Demo: <code>admin@trafficsignal.io</code> / <code>admin123</code>
        </p>
      </form>
    </div>
  );
